...
export default function Hero() {
  ...
  return (
    <section className="sui-blue-bg min-h-screen relative overflow-hidden w-full">
      {/* Main content container with flex to center everything */}
      <div className="flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 w-full">
        {/* Freedom banner */}
