    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-blue-100 to-indigo-100 border border-blue-200 text-sui-navy hover:shadow-md hover:scale-105 transition-all duration-200 cursor-pointer">
            {isLoading ? (
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-sm font-semibold">{sgUSDBalance} <span className="text-blue-500">sgUSD</span></span>
              </div>
            )}
          </div>
        </TooltipTrigger>
